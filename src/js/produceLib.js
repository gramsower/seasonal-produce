...
//Vegetables
let asparagus = new Produce('asparagus', ['winter', 'spring', 'summer', 'fall'], 'asparagus.jpeg','Asparagus comes in green, white, purple and wild varieties. Look for the thinnest stalks possible; these are the most tender. Steer clear of limp and wilted asparagus.');
...
let olive = new Produce('olive', ['winter', 'spring', 'summer', 'fall'], 'olive.jpeg', 'Olives come in a variety of colors and may come whole or with the pit already removed. Fresh, cured olives should be kept in the refrigerator to extend their life for a few weeks.');
let radish = new Produce('radish', ['winter', 'spring', 'summer', 'fall'], 'radish.jpeg', 'Most radishes are sold with the tops attached: look for vibrant greens and firm roots. Do not forget you can saute the tops or use them in pesto!');
...
let cantaloupe = new Produce('cantaloupe', ['winter', 'spring', 'summer', 'fall'], 'cantaloupe.jpeg', 'Look for a cantaloupe with no nicks in the rind or mold on the blossom end. If it is perfectly ripe, the end should smell nice. Avoid melons with soft spots.');
...
let chickpeas = new Produce('chickpeas', ['winter', 'spring', 'summer', 'fall'], 'chickpeas.jpeg', 'Also known as garbanzo beans, the fresh green pods (and seeds inside) are edible, but most are harvested dried. Chickpea leaves are also edible.');
...
let shellBeans = new Produce('shell beans', ['winter', 'spring', 'summer', 'fall'], 'shell-bean.jpeg', 'Fresh shell beans cook much quicker than their dried out counterparts. Look for pods that have pronounced, evenly sized bumps and avoid those with noticeable empty spots.');
...
let snapPeas = new Produce('snap peas', ['winter', 'spring', 'summer', 'fall'], 'snap-peas.jpeg', 'Snap peas are excellent raw or cooked. When shopping, look for those with full pods that are vibrant in color, avoiding any with mushy spots.');
...
let snowPeas = new Produce('snow peas', ['winter', 'spring', 'summer', 'fall'], 'snow-peas.jpeg', 'Good snow peas will be bright green with thin, flexible pods. Snow peas are mildly flavored and can be served raw or cooked.');
